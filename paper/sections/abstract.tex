...
We provide public code, evaluation artifacts, and trained model checkpoints to support reproducibility and position this work as a foundation for future official SWE-bench \texttt{FAIL\_TO\_PASS} evaluation.
