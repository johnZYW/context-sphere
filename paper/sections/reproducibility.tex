...
The artifact repository also includes the retrieval configuration files and per-case result ledgers used to reconstruct Tables~\ref{tab:verified-ablation-100} and~\ref{tab:projection_results}. Full reproduction instructions and the complete artifact package are available at \url{https://github.com/johnZYW/context-sphere}.
